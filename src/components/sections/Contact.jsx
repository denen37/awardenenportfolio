...
const Contact = () => {
  return (
    <section id="contact" className='bg-surface'>
      ...
      <div className='mx-auto w-[90%] px-10 py-10 mt-5 rounded-lg bg-card'>
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-6'>
            ...
            <div className="flex flex-col gap-1">
                    ...
                    <input
                        ...
                        className="w-full rounded-lg border border-surface bg-background px-3 py-2 text-sm text-text-primary outline-none transition-all duration-300 placeholder:text-text-secondary focus:border-accent focus:ring-2 focus:ring-accent/20"/>
                </div>
